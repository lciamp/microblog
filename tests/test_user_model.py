...
class UserModelTestCase(unittest.TestCase):
    ...
    def test_password_has_no_getter(self):
        u = User(password='cat')
    ...
    def test_roles_user(self):
        u = User(email='lou@me.com', password='cat')
    ...
    def test_follows(self):
        ...
        self.assertFalse(u1.followed.count() == 2)
        self.assertFalse(u2.followers.count() == 2)
        f = u1.followed.all()[-1]
        ...
        db.session.add(u1)
        db.session.commit()
        self.assertFalse(u1.followed.count() == 1)
        self.assertFalse(u2.followers.count() == 1)
        self.assertFalse(Follow.query.count() == 2)
        u2.follow(u1)
        db.session.add(u1)
        db.session.add(u2)
        db.session.commit()
        ...
        db.session.commit()
        self.assertFalse(Follow.query.count() == 1)